...
Python client for `Last.fm API <http://www.last.fm/api>`_.
Async, Tornado-based version of the client in included as well.
It provides a pythonic interface to all the API's method, including oAuth, etc.
